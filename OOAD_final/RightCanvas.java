...
// Assuming CanvasPanel is a JPanel or extends JPanel appropriately
class RightCanvas extends CanvasPanel {
    ...
    public RightCanvas(DrawingToolPanel toolPanel) {
        ...
        setBackground(Color.WHITE); // Ensure white background
        setupDrawing();
    ...
    private void setupDrawing() {
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                // Add a small dot for the initial press
    ...
    protected void paintComponent(Graphics g) {
        super.paintComponent(g); // This draws the white background
    ...
    // Method to save canvas - HEAVILY DEBUGGED VERSION
    public BufferedImage saveToImage() {
        ...
        // Use the preferred size from CanvasPanel (650x730)
        int width = getPreferredSize().width;
        int height = getPreferredSize().height;
        
        // Fallback to actual size if preferred size is not set
        ...
        // Let's also try to verify the image has content by checking some pixels
    ...
    // Debug method to check if drawing instructions are being stored
    ...
    // Helper class to store drawing instructions
